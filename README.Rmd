...
[![CRAN status](https://www.r-pkg.org/badges/version/ascotraceR)](https://CRAN.R-project.org/package=ascotraceR)
<!-- badges: end -->
...
## A note on possible _Rcpp_ errors
...
Please update your _Rcpp_ installation by using:

```r
install.packages("Rcpp")
```

Then restart your R session and resume issuing the commands from _ascotraceR_.
