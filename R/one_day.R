...
#'         * cumulative wet hours - `cwh`
#'         * cumulative rainfall in mm - `cr`
#'         * standard growing points assuming growth is not impeded by infection - `gp_standard`
#'   * new growing points produced in the last 24 hours - `new_gp`
#'   * a `data.table` of only infectious growing points - `infected_coords`
#'   * a `data.table` of newly infected growing points `new_infections`
#'   * a `data.table` of exposed growing points in the latent period phase of infection - `exposed_gps`.
#'
#' @keywords internal
#' @noRd
