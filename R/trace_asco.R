...
#'   was added to each of the sub-unit corresponding to the point of initial
#'   infection in the field. Defaults to `10`.
...
#'
#' traced[[70]] # extracts the model output for day 70
#'
#' @export
#'
