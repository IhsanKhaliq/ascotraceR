...
#'
#' @return A nested `list` object where each sub-list contains daily data
#'  for the day `i_day` (the model's iteration day) generated by the model
#'  including:
#'  * **paddock**, an 'x' 'y' \CRANpkg{data.table} containing:
#'     * **x**, location of quadrat on x-axis in paddock,
#'     * **y**, location of quadrat on y-axis in paddock,
#'     * **new_gp**, new growing points produced in the last 24 hours,
#'     * **susceptible_gp**, susceptible growing points in the last 24 hours,
#'     * **exposed_gp**, exposed growing points in the last 24 hours,
#'     * **infectious_gp**, infectious growing points in the last 24 hours,
#'   * **i_day**, model iteration day,
#'   * **cumulative daily weather data**, a \CRANpkg{data.table} containing:
#'     * **cdd**, cumulative degree days,
#'     * **cwh**, cumulative wet hours,
#'     * **cr**, cumulative rainfall in mm,
#'     * **gp_standard**, standard growing points assuming growth is not impeded
#'      by infection,
#'   * **infected_coords**, a \CRANpkg{data.table} of only infectious growing
#'    point coordinates,
#'   * **new_infections**, a \CRANpkg{data.table} of newly infected growing
#'    points,
#'   * **exposed_gp**, a \CRANpkg{data.table} of exposed growing points in the
#'    latent period phase of infection.
#'
