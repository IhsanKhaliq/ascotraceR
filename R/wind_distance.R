...
#' Conidia are assumed to spread from the centre of each subunit. The
#' destination subunit, where conidia land, could be the same subunit or another
#' subunit within or outside the paddock. If conidia land outside the paddock,
#' the model can simulate the spread outside the paddock when the wrapping
#' option is chosen. When the wrapping option is not chosen, the model simulate
#' disease spread within the paddock
#'
